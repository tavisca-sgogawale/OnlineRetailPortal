...
namespace OnlineRetailPortal.Mock
{
    public class MockProductStore : IProductStore
    {
        static List<Product> productList = new List<Product>() {
            new Product{SellerId="1",Id="101",Name="Mobile", Price=new Price{Money = new Money(200.0, "INR"), IsNegotiable=true}, Category = new Contracts.Category(){ Name = "Mobile"},
            ...
            new Product{SellerId="2",Id="102",Name="Bottle", Price=new Price{ Money = new Money(200.0, "INR"), IsNegotiable=true}, Category = new Contracts.Category(){ Name = "Others"},
                HeroImage = "https://www.olx.in/item/11-pro-max-64-gb-full-box-iid-1540782056/gallery",
             ...
             new Product{SellerId="3",Id="103",Name="Computer", Price=new Price{Money= new Money(200.0, "INR"), IsNegotiable=false},Category = new Contracts.Category(){ Name = "Electronics"},
                HeroImage = "https://www.olx.in/item/11-pro-max-64-gb-full-box-iid-1540782056/gallery",
